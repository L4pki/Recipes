                ...
                <div className="recipe-about">
                    ...
                    <div className="recipe-info-third">
                        <div className="recipe-time">
                                ...
                                <p className="recipe-time-text">Время приготовления:</p>
                                <p className="recipe-time-value">{minutesFromTimeString(recipe.timeCosts)} минут</p>
                                </div>
                        </div>
                        <div className="recipe-person">
                                ...
                                <p className="recipe-person-value">{recipe.numberOfPersons} персон </p>
                                </div>
                        </div>
                    </div>
                </div>
